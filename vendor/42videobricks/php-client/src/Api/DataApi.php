...
/**
     ...
     */
    public function getDataVideoUsage($limit = null, $offset = null, string $contentType = self::contentTypes['getDataVideoUsage'][0])
    {
        list($response) = $this->getDataVideoUsageWithHttpInfo($limit, $offset, $contentType);
        return $response;
    }
     ...
     */
    public function getDataVideoUsageWithHttpInfo($limit = null, $offset = null, string $contentType = self::contentTypes['getDataVideoUsage'][0])
    {
        $request = $this->getDataVideoUsageRequest($limit, $offset, $contentType);
     ...
     */
    public function getDataVideoUsageAsync($limit = null, $offset = null, string $contentType = self::contentTypes['getDataVideoUsage'][0])
    {
        return $this->getDataVideoUsageAsyncWithHttpInfo($limit, $offset, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getDataVideoUsageAsyncWithHttpInfo($limit = null, $offset = null, string $contentType = self::contentTypes['getDataVideoUsage'][0])
    {
        $returnType = '\Api42Vb\Client\Model\DataVideoUsageList';
        $request = $this->getDataVideoUsageRequest($limit, $offset, $contentType);
     ...
     */
    public function getDataVideoUsageRequest($limit = null, $offset = null, string $contentType = self::contentTypes['getDataVideoUsage'][0])
    {
