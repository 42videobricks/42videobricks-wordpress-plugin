    ...
    */
    ...
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $description when calling Video., must be smaller than or equal to 2048.');
        }
     ...
     * Sets status
     *
     * @param string|null $status Status of the video : * 'REQUESTED': video as been submited, waiting for its creation * 'CREATED': video has been created and file can be uploaded          * 'TRANSCODING': video is unvailable because still in the creation  & in encoding process * 'AVAILABLE': video is ready to be stream
     *
     * @return self
     */
