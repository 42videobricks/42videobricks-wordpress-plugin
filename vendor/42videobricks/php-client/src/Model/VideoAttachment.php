...
/**
 * VideoAttachment Class Doc Comment
 *
 * @category Class
 ...
 */
class VideoAttachment implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VideoAttachment';
    ...
    public const ATTACHMENT_TYPE_CAPTION = 'caption';
    public const ATTACHMENT_TYPE_SUBTITLE = 'subtitle';
    ...
    {
        return [
            self::ATTACHMENT_TYPE_CAPTION,
            self::ATTACHMENT_TYPE_SUBTITLE,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('attachment_type', $data ?? [], 'caption');
    ...
    */
     ...
     *
     * @param string|null $attachment_type Attachment type
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string|null $url the path of the content
     *
     * @return self
     */
     ...
     * Sets locale
     *
     * @param string|null $locale the local of attachment
     *
     * @return self
     */
