 ...
 */
class WebhookProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WebhookProperties';
    ...
    */
    ...
    public function setUrl($url)
    {
        ...
        if ((mb_strlen($url) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $url when calling WebhookProperties., must be smaller than or equal to 2048.');
        }
     ...
     * Sets token
     *
     * @param string|null $token Optionnal Secret token to validate notifications. Sent with the request in the X-Vpass-Token HTTP header.
     *
     * @return self
     */
    public function setToken($token)
    {
        ...
        if ((mb_strlen($token) > 256)) {
            throw new \InvalidArgumentException('invalid length for $token when calling WebhookProperties., must be smaller than or equal to 256.');
        }
     ...
     * Sets event_type
     *
     * @param string[] $event_type List of event to be notified:   * VIDEO_STATUS: Get Video object status modification notifications   Status values: REQUESTED, CREATED, TRANSCODING, AVAILABLE, DELETED   * VIDEO_TRANSCODING_PROGRESS: Get transcoding progression notifications
     *
     * @return self
     */
